...
# AtteConDA-SDE-UniCon-90K

Checkpoint for the 90K-step AtteConDA model initialized from a Uni-ControlNet-compatible starting point.
...
- **Model name:** `AtteConDA-SDE-UniCon-90K`
- **Paper-side label:** `Tune90K`
- **Variant type:** 90K-step tuned model with Uni-ControlNet-compatible initialization
