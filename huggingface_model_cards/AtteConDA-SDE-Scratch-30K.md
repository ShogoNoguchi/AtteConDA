...
Checkpoint for the from-scratch 30K-step AtteConDA baseline without Uni-ControlNet initialization.
...
- **Model name:** `AtteConDA-SDE-Scratch-30K`
- **Paper-side label:** `FullScratch30K`
- **Variant type:** from-scratch 30K-step baseline without Uni-ControlNet pretrained initialization
