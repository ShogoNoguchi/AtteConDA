...
# AtteConDA-SDE-UniCon-30K

Checkpoint for the 30K-step AtteConDA model initialized from a Uni-ControlNet-compatible starting point.
...
- **Model name:** `AtteConDA-SDE-UniCon-30K`
- **Paper-side label:** `Tune30K`
- **Variant type:** 30K-step tuned model with Uni-ControlNet-compatible initialization
