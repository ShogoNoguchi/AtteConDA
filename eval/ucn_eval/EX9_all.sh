#!/usr/bin/env bash
# /home/shogo/coding/eval/ucn_eval/EX9_all.sh
set -euo pipefail

# ========== ==========
# 生成画像: DGInStyle + Qwen プロンプト → /data/coding/datasets/WaymoV2/DGInstyle_Pure
# 評価キャッシュ: /data/ucn_eval_cache_ex9

# 0) キャッシュ
mkdir -p /data/ucn_eval_cache_ex9 /data/ucn_eval_cache_ex9/torch_hub
...
docker run --rm --gpus all \
  ...
  --experiment-id EX9 \
  --experiment-note "DGInStyle_Pure + Qwen3-VL prompts" \
