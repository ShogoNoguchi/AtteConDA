...
# AtteConDA-SDE-UniCon-60K

Checkpoint for the 60K-step AtteConDA model initialized from a Uni-ControlNet-compatible starting point.
...
- **Model name:** `AtteConDA-SDE-UniCon-60K`
- **Paper-side label:** `Tune60K`
- **Variant type:** 60K-step tuned model with Uni-ControlNet-compatible initialization
